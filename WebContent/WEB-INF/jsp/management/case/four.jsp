...
<form id="pagerForm" method="post" action="<%=baseUrl %>/management/case/cfour" onsubmit="return divSearch(this,'${divflag}')">
...
<div class="panelBar">
	...
	<div class="pagination" rel="${divflag}" totalCount="${total4}" numPerPage="${vo.pageSize}" pageNumShown="10" currentPage="${vo.pageNum}"></div>
</div>
