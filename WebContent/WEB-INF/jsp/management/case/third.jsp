...
<form id="pagerForm" method="post" action="<%=baseUrl %>/management/case/cthird" onsubmit="return divSearch(this,'${divflag}')">
...
<div class="panelBar">
	...
	<div class="pagination" rel="${divflag}" totalCount="${total3}" numPerPage="${vo.pageSize}" pageNumShown="10" currentPage="${vo.pageNum}"></div>
</div>
