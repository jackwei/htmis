...
<form method="post" action="<%=baseUrl %>/management/chapter/update?navTabId=bookNav&callbackType=closeCurrent" class="pageForm required-validate" onsubmit="return validateCallback(this, dialogAjaxDone);">
