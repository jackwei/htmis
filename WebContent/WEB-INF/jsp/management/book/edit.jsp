...
<form id="pagerForm" method="post" action="<%=baseUrl %>/management/book/edit/${book.id}">
	<input type="hidden" name="pageNum" value="1" />
</form>

<div class="pageContent">
<form method="post" action="<%=baseUrl %>/management/book/update?navTabId=bookLiNav" class="pageForm required-validate" onsubmit="return validateCallback(this,navTabAjaxDone);">
	...
	<div class="pageFormContent" layoutH="56">
		...
		<p>
			<label>出版日期: </label>
			<input type="text" name="publishDate" class="date required" class="date required" value="<fmt:formatDate value="${book.publishDate}" pattern="yyyy-MM-dd"/>"/>
		...
		<a class="button" target="dialog" mask="true" width="800" height="400" href="<%=baseUrl %>/management/chapter/add/${book.id}"><span>添加篇章</span></a>
