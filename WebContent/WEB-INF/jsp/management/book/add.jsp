...
<form method="post" action="<%=baseUrl %>/management/book/insert?navTabId=bookLiNav" class="pageForm required-validate" onsubmit="return validateCallback(this,navTabAjaxDone);">
	<div class="pageFormContent" layoutH="56">
		...
		<p>
			<label>出版日期: </label>
			<input type="text" name="publishDate" class="date required" class="date required"/>
