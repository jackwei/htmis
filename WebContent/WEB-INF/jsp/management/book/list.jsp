...
<form method="post" rel="pagerForm" action="<%=baseUrl %>/management/book" onsubmit="return navTabSearch(this)">
...
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
			<li><a class="add" target="navTab" href="<%=baseUrl %>/management/book/add" title="添加书目"><span>添加</span></a></li>
			<li><a class="edit" target="navTab" rel="bookNav" href="<%=baseUrl %>/management/book/edit/{slt_objId}" title="编辑书目"><span>编辑</span></a></li>
