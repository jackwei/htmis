...
<form method="post" rel="pagerForm" action="<%=baseUrl %>/management/claimHandle/searchPay?flag=${flag}" onsubmit="return navTabSearch(this)">
...
<div class="pageContent">
	...
	<div class="panelBar">
		<ul class="toolBar">
	 		<li><a class="edit" target="navTab" rel="claimHandleNav" href="<%=baseUrl %>/management/claimHandle/claimPay/{claimId}" title="赔款划付"><span>处理</span></a></li>
