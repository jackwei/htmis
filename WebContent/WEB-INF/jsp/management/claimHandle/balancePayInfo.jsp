...
<div class="pageContent">
 		<form id="balanceForm" method="post" action="<%=baseUrl %>/management/claimHandle/insert?navTabId=claimPayListNav&callbackType=closeCurrent" class="pageForm required-validate" onsubmit="return validateCallback(this,navTabAjaxDone);">
				...
				<input type="hidden" id="remark1" name="remark1" value="<%= caseClaimImpl.getRemark1()==null ? "":caseClaimImpl.getRemark1() %>"/>
				...
				<div class="pageFormContent" layoutH="236">
					...
					<p>
						<label>申请金额：</label>
						<input type="text" readonly="readonly" name="recordmount" id="realamount"  onchange="calculate();" class="required" size="30" value="<%= caseClaimImpl.getRecordmount()==null ? 0.0:caseClaimImpl.getRecordmount() %>" />
					</p> 
					<p>
						<label>划付币种：</label>
					...
					<p>
						<label>划付金额：</label>
						<input type="text" name="realamount" id="realamount"  onchange="calculate();" class="required" size="30" value="<%= caseClaimImpl.getRealamount()==null ? 0.0:caseClaimImpl.getRealamount() %>" />
					</p>
					<p>
						<label>划付时间：</label>
				...
				<div class="formBar">
					<ul>
						<li><div class="button"><a rel="bill" href="javascript:uploadDoc();" ><span>确认退回</span></a></div></li>
					
						<!-- <li><div class="buttonActive"><div class="buttonContent"><button type="submit">确认退回</button></div></div></li> -->
