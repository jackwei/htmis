...
<form method="post" rel="pagerForm" action="<%=baseUrl %>/management/billCheck/searchChecked" onsubmit="return divSearch(this,'billChecked')">
...
<div class="pageContent" >
	...
	<div class="panelBar">
		<div class="pages">
			<span>Per Page</span>
			<select name="pageSize" onchange="dwzPageBreak({targetType:'navTab',data:{numPerPage:this.value}})">
