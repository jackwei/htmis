...
<form method="post" rel="pagerForm" action="<%=baseUrl %>/assure/consignor/search?st=<%=st %>"  onsubmit="return dwzSearch(this, 'dialog');">
	...
	<div class="panelBar">
	 ...
	 <table class="table" width="100%"  layoutH="140">
		<thead align="center">
			<tr>
			    <th width="10%"></th>
				<th width="30%" >委托人简称</th>
				<th width="50%" >委托人全称</th>
				<th width="10%">查找带回</th>
			</tr>
		</thead>
		<tbody align="center">
