...
<form method="post" rel="pagerForm" action="<%=baseUrl %>/client/consignor/countrysearch"  onsubmit="return dwzSearch(this, 'dialog');">
	...
	<div class="searchBar">
		...
		<div class="subBar">
			<ul>						
				...
				<li><div class="buttonActive"><div class="buttonContent"><button onclick="$.bringBack({country:''});">清空</button></div></div></li>
			</ul>
		</div>
	</div>
</div>
	...
	<div class="panelBar">
	 ...
	 <table class="table" width="100%"  layoutH="140">
		...
		<c:forEach var="item" items="${menuList}" varStatus="s">
			<tr multLookup="consignorItems" lookupGroup="consignorType" onclick="$.bringBack({country:'${item.country}'});" >
			    <td>${s.index + 1}</td>
				<td>${item.country}</td>
	<%-- 			<td>
				<div>
