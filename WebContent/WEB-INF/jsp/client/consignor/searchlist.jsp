...
<form method="post" rel="pagerForm" action="<%=baseUrl %>/client/consignor/sortsearch"  onsubmit="return dwzSearch(this, 'dialog');">
	...
	<div class="searchBar">
		...
		<div class="subBar">
			<ul>						
				...
				<li><div class="buttonActive"><div class="buttonContent"><button onclick="$.bringBack({SortNo:'',DictName:''});">清空</button></div></div></li>
			</ul>
		</div>
	</div>
</div>
	...
	<div class="panelBar">
	 ...
	 <table class="table" width="100%"  layoutH="140">
		<thead align="center">
			<tr>
			    <th width="10%"></th>
				<th width="80%" >委托人分类</th>
				<!-- <th width="10%" >查找带回</th> -->
			</tr>
		</thead>
		<tbody align="center">
		<c:forEach var="item" items="${menuList}" varStatus="s">
			<tr multLookup="consignorItems" lookupGroup="consignorType" onclick="$.bringBack({SortNo:'${item.SortNo}',DictName:'${item.DictName}'});" >
			    <td>${s.index + 1}</td>
				<td>${item.DictName}</td>
	<%-- 			<td>
				<div>
