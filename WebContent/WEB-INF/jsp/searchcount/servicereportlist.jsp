...
<c:import url="../layout/pager/pagerForm.jsp"></c:import>
    ...
    <div class="panel" >
		<form method="post" rel="pagerForm" action="<%=baseUrl%>/searchcount/standardcondition?standardflag=passuresortreport" onsubmit="return navTabSearch(this)">
...
<div class="pageContent">
	<table class="table" width="100%" layoutH="53">
		...
		<tbody>
		<c:forEach var="item" items="${psreportList}" varStatus="s">
			<tr >
				<td>${s.index + 1}</td>
