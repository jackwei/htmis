...
<c:import url="../layout/pager/pagerForm.jsp"></c:import>
	...
	<div class="panel" >
		<h1>担保账务<a>${startdate} - ${enddate}</a></h1>
		<form method="post" rel="pagerForm" action="<%=baseUrl%>/searchcount/searchcondition?searchflag=passureinfosbill" onsubmit="return navTabSearch(this)">
	...
	<table class="table" width="100%" layoutH="80">
		...
		<c:forEach var="item" items="${passureList}" varStatus="s">
			<tr>
				...
				&propertyname=${propertyname}&currency=${item.currency}&country=${country}&receiver=${receiver}&sender=${sender}&trackingNumber=${trackingNumber}&feestatuse=${item.feestatuse}&radio=${radio}&groupid=${item.groupid} " 
