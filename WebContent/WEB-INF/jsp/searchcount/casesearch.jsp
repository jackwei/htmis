...
<c:import url="../layout/pager/pagerForm.jsp"></c:import>
    ...
    <div class="panel" >
		<h1>案件查询  <a>${startdate} - ${enddate}</a></h1>
		<form method="post" rel="pagerForm" action="<%=baseUrl%>/searchcount/searchcondition?searchflag=casesearch" onsubmit="return navTabSearch(this)">
		...
		<a id="cases" rel="caseNav" class="edit" target="navTab" href="<%=baseUrl %>/management/case/edit/{caseId}" title="案件信息"></a>
...
<div class="pageContent">
	<table class="table" width="100%" layoutH="80">
		...
		<c:forEach var="item" items="${caseList}" varStatus="s">
			<tr target="caseId" rel="${item.caseId }" ondblclick="casesh()">
				<td>${s.index + 1}</td>
