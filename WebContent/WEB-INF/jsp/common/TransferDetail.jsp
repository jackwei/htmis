		...
		<div class="tabsContent">
			<div>
				<div layoutH="146" style="float:left; display:block; overflow:auto; width:600px; border:solid 1px #CCC; line-height:21px">
					...
					<div class="STYLE3" style=" margin-left:100px;margin-top:20px">支付海事代收代付费申请</div>
						...
						<div class="STYLE2" id="cpjinfo" style="text-align:left; width:500px; margin-right:10px; margin-top:20px">
							...
							<br>
							<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;就题述事宜，经协商，【<span><font color="red" style="TEXT-DECORATION: underline">${caseInfo.consignorname}</font></span>】
							同意赔偿索赔方【<span><font color="red" style="TEXT-DECORATION: underline">${caseClaim.recordcurrency}:${caseClaim.recordmount}</font></span>】。
							&nbsp;委托人已将【<span><font color="red" style="TEXT-DECORATION: underline">${caseClaim.transfercurrency}:${caseClaim.transfermount }</font></span>】 汇至我司账户。					         
							</p>
							<br>							
							<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;有鉴于此，为妥善处理此事，特申请将此笔赔款划付至指定的如下银行账户：
							<br>
							<br>
							<p>&nbsp;&nbsp;&nbsp;&nbsp;收&nbsp;&nbsp;款&nbsp;人： <span><font color="red" style="TEXT-DECORATION: underline">${caseClaim.clientname }</font></span></p>
          					...
          					<br><p>&nbsp;&nbsp;&nbsp;&nbsp;申请币种： <span><font color="red" style="TEXT-DECORATION: underline">${caseClaim.recordcurrency }</font></span></p>
          					<br><p>&nbsp;&nbsp;&nbsp;&nbsp;申请金额： <span><font color="red" style="TEXT-DECORATION: underline">${caseClaim.recordmount }</font></span></p>
