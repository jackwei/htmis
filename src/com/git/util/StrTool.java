...
//        strReturn += strMain.substring(intStartIndex, strMain.length());
    ...
    */
    public static void main(String[] args) {
       ...
       System.out.println("过滤后：" + StrTool.stringFilter(t_str1));
       // 测试合并字符串
       String[] t_str_arr1 = { "PG_1", "PG_2", "PG_3" };
       String t_str2 = StrTool.stringConnect(t_str_arr1, ",");
       System.out.println("t_str2=" + t_str2);
       // 测试拆分字符串
       String[] t_str_arr2 = StrTool.stringSpilit(t_str2, ",");
